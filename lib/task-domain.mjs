...
export function toPublicTask(task, schedule = null) {
  ...
  return {
    ...
    schedule: schedule ? {
      ...
      startTime: formatMinutes(schedule.startMinutes),
      endTime: formatMinutes(schedule.endMinutes),
      timezone: schedule.timezone,
      sourceBlockId: schedule.sourceBlockId,
    } : null,
  };
}
